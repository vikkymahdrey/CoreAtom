...
<body onload="loadScript();">
	<%
		...
		routedetails=new RouteService().getAutogeneratedRoute(routeid);
						...
						<div class="col-sm-12">
							...
							<div class="breadcrumb-wrap">
								<a href="employee_home.jsp"><img src="images/home.png" /></a> <a
									href="employee_home.jsp">My Information </a>
						
								<a href="#" class="current">Create Route1</a>
							</div>
							<div class="content-wrap">
								...
								<select name="empid" id="empid" multiple="multiple"
									...
									multiple="multiple" id="points" style="display: none;"><option
										value="12.8451923*77.6594844">(12.8451923,
										77.6594844)</option>
									<%
...
<script>
	...
	var cityLat;
	var cityLon;
	var emplat = 12.8451923;
	var emplong = 77.6594844;
	var place;
