...
<script type="text/javascript">
...

	{
		if (confirm()) {
			...
			try {
				...
				xmlhttp.open("POST", "GetEmployeeData?employeeID="
	...
	function selectRow(id) {
		...
		try {			
			...
			opener.document.getElementById("userType1").value = userType;
			 
			this.close();
		} catch (e) {
			opener.document.getElementById("supervisorID1").value = id;
			opener.document.getElementById("supervisorName1").value = name;
			this.close();
		}
	}
</script>
