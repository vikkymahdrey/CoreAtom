...
<body>
	...
	<div id="body">
		<div class="content">
			<br />
			<form action="routeListShuttle.jsp" name="siteForm" id="siteForm">
				<table>
					<tr>
						<td>Site</td>
			...
			<%
				ArrayList<RouteDto> routeDtoList = new RouteService()
						.getAllShuttleRoutes(site);
			%>
			<h3>Route List</h3>
			<hr />
			<p align="center">
				<a href="downloadroute.jsp?site=<%=site%>">Download all routes</a>
			</p>
			<table>
				...
				<thead>
					...
					<tr>
						...
						<th align="center">AssignVehicle</th>
				...
				<tr>
					...
					<td align="center"><a
						href="shuttleRouteModify.jsp?routeId=<%=routeDto.getRouteId()%>"><%=routeDto.getRouteName()%></a></td>
					<td align="center"><%=routeDto.getSiteName()%></td>
					<td><%=routeDto.getInOut()%></td>
					<td><a
						href="editShuttleRoute.jsp?routeId=<%=routeDto.getRouteId()%>">Edit</a></td>
						<td><a href="assignShuttleVehicle.jsp?routeId=<%=routeDto.getRouteId()%>&inOut=<%=routeDto.getInOut()%>&site=<%=site%>">Assign vehicle</a></td>
