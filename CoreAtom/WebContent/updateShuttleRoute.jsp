...
<%@include file="Header.jsp"%>
	<%
		...
		empinroute=new RouteService().getEmployeeFromShuttleRoute(routeid);
			}
	...
	function validate() {
 	...
 	function showroute(){
 		...
 		for(GeoTagDto dto : empinroute){%>
 			...
 			preemp="/"+'<%=dto.getEmpid()%>'+"#"+'<%=dto.getEmpName()%>'+"#"+'<%=dto.getPersonnelNo()%>' + "#<%=dto.getDistanceperadmin()%>#<%=dto.getDistanceperadminout()%>" + preemp;
		var optionNew = document.createElement('option');
