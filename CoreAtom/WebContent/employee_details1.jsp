...
if(fname=="" || fname==null || fname==" "){
  ...
  <%
						...
						String stateK="selected",stateT="",stateU="",stateDL="",stateHR="";
						 ...
						 ArrayList<LogTimeDto> inLog = new LogTimeService()
							.getAllLogtime("IN", empDtoInHeader.getSite());
					ArrayList<LogTimeDto> outLog = new LogTimeService()
							.getAllLogtime("OUT", empDtoInHeader.getSite());
...
<%if(session.getAttribute("roleId").equals("2") ){ %>
				...
				<form action="shuttlesubDetails1.jsp" id="UserDetails" method="post"
				...
				<%if(request.getParameter("id")==null) { %>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-7 col-xs-6 mar-top-15"><input type="text" name="fname" id="fname"
							...
							value="<%=dto.getEmailAddress()%>"> <input
							type="hidden" name="homelatlong" id="homelatlong"
							value="<%=homelatlong%>" /></div>
					...
					<div class="row">
						...
						<textarea class="addresstextarea form-control" name="addr" id="addr"><%=dto.getAddress() %></textarea>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-5 col-sm-7 col-xs-6 mar-top-15">
									<select class="form-control" name="state" id="state">
										...
										<option value="UP" <%=stateU %>>UP</option>
										<option value="DL" <%=stateDL %>>DELHI</option>
										<option value="HR" <%=stateHR %>>HARYANA</option>
									</select>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-4 col-sm-5 mandatory">I would be interested in a transport facility</div>
						<div class="col-md-3 col-sm-4">
								YES&nbsp;&nbsp;<input type="radio" name="interest" id="interest"
							value="yes"   >&nbsp;&nbsp;NO&nbsp;&nbsp;<input
							type="radio" name="interest" id="interest" value="no" checked="checked" /></div>
					...
					<div class="row tripping">
						...
						<div class="col-md-2 col-sm-5 col-xs-6 mar-top-15 col-md-offset-2 text-lightgrey mandatory">Out Time:</div>
					...
					<%}else{
						...
						String stateK1="checked='checked'",stateT1="",stateUP="",stDL="",stHR="",same1="",diff1="",ignore1="",hidn="",yess="",nos=" ";
							...
							<div class="row">
								...
								<div class="col-md-5 col-sm-7 col-xs-6 mar-top-15">
									<select class="form-control" name="state" id="state">
										...
										<option value="UP" <%=stateUP %>>UP</option>
										<option value="DL" <%=stDL %>>DELHI</option>
										<option value="HR" <%=stHR %>>HARYANA</option>
									</select>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-5 mandatory">I would be interested in a transport facility</div>
						<div class="col-md-3 col-sm-4">
						<!-- 	<select class="form-control">
								<option>Select One</option>
							</select> -->YES&nbsp;&nbsp;<input type="radio" name="interest" id="interest"
							value="yes"   <%=yess %>/>&nbsp;&nbsp;NO&nbsp;&nbsp;<input
							type="radio" name="interest" id="interest" value="no"  <%=nos %>/>					
						</div>
						<div class="col-md-6 col-sm-12 text-right tripping">
						</div>
