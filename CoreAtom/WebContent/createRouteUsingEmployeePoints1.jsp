	...
	<div class="wrapper">
		...
		<div class="main-page-container">
			<div class="container">
				...
				<div class="row">
					<form action="createRouteUsingEmployeePoints1.jsp" method="post"
							...
							<div class="content-wrap">
								...
								<select name="empid" id="empid" multiple="multiple"
									...
									multiple="multiple" id="points" style="display: none;"><option
										value="12.6810066*77.4353909">(12.6810066,
										77.4353909)</option>
								</select>
								<div class="push">
									<div class="row">
				...
				<div class="modal-content">
					...
					<div class="modal-footer text-center">
						<button type="button" class="btn btn-blue" data-dismiss="modal">
							<a onclick="removepoint1();">Remove</a>
						</button>
					</div>
				</div>
				<!-- /.modal-content -->
...
<script>
	...
	function getEmployee() {
		...
		try {
			...
			xmlhttp.open("POST", "GetEmployeeNearNoodle?logtype="+logtype+"&logtime="+logtime+"&dist=" + compareconst
