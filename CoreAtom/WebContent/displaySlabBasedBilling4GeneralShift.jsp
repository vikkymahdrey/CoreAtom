...
<body>
	...
	<div id="body">
		...
		String  url="displaySlabBasedBilling4GeneralShiftDaily.jsp?siteId=" + siteID+"&fromDate="+fromDate+"&toDate="+toDate+"&vendor="+vendor;
		//vendor="1";
	...
	%>
	 ...
	 <hr/>
			<div>
				<form name="form1" action="displaySlabBasedBilling4GeneralShift.jsp"
			...
			<hr />
			<br />
			<h2 align="center">Km Based Template Billing Report - General Shift</h2>
			<hr />
			<%
			ArrayList<TripBasedBillingReportHelperDto> dtoList =null;
			try{
				dtoList = new SlabBasedBillingReportHelperDao() .getSlabBasedBillingTripCostReport_monthly (siteID, vendor, vehicleType, fromDate, toDate,month,year,escort );
