...
<body onload="loadScript();">
	...
	EmployeeDto empDtoInHeader = null;
		...
		.getEmployeeAccurate(session.getAttribute("user")
			...
			String type=null;
			String time=null;
			String intype="",outtype="",filter="",site1="";
			String homeflt="",picflt="",dropflt="";
			if(request.getParameter("type")!=null){
		type=request.getParameter("type");
		time=request.getParameter("time");
		site1=request.getParameter("site");
		filter=request.getParameter("filter");
		if(filter.equalsIgnoreCase("home")){
			homeflt="selected";
		}else if(filter.equalsIgnoreCase("pickup")){
			picflt="selected";
		}else if(filter.equalsIgnoreCase("drop")){
			dropflt="selected";
		}
	...
	<div class="wrapper">
		...
		<div class="main-page-container">
			<div class="container">
				...
				<div class="row">
					<form action="createShuttleRouteKeo.jsp" method="post"
						...
						<div class="col-sm-12">
							<div class="breadcrumb-wrap">
								<a href="employee_home.jsp"><img src="images/home.png" /></a> <a
									...
									<a href="#" class="current">Create Route</a>
							...
							<div class="content-wrap">
								...
								<div class="push">
									<div class="row">
										<div
											class="col-md-1  mar-top-15 text-lightgrey">Site</div>
										<div class="col-md-2  mar-top-15">
											<select id="site" name="site" onchange="getTime();"
												class="form-control" style="width: 100%;">
												<option value="ALL">SELECT</option>
												<%
									for (SiteDto siteDto : siteDtoList) {
										String selected="";
										if(siteDto.getId().equalsIgnoreCase(site1)){
											selected="selected";
										}
								%>

								<option  value="<%=siteDto.getId()%>" <%=selected %>><%=siteDto.getName()%></option>
								<%
									}
								%>
											</select>
										...
										<div
											class="col-md-1  mar-top-15 text-lightgrey">Log
											Type</div>
										<div class="col-md-2  mar-top-15">
										...
										<div
											class="col-md-1  mar-top-15  text-lightgrey">Filter By</div>
										<div class="col-md-2  mar-top-15">
											<select id="filter" name="filter" class="form-control"
												style="width: 100%;">
												<option value="home" <%=homeflt %>>HOME</option>
												<option value="pickup" <%=picflt %> >PickUp</option>
												<option value="drop" <%=dropflt %> >Drop</option>
											</select>
										</div>
										<div class="col-md-1  col-xs-6 mar-top-15 ">
				...
				<div class="row">
					<form action="AddRouteInMap1" method="post"
						...
						<div class="col-sm-12">
							<div class="content-wrap">
							<input type="hidden" id="site" name="site" value="<%=site1%>" />
							<input type="hidden" id="type" name="type" value="<%=type%>" />
								<input type="hidden" id="filter1" name="filter1" value="<%=filter%>" />
								...
								<div class="row">
									...
									<div class="col-md-2 col-sm-2 col-xs-3 mar-top-15">
										<select name="vt" id="vt" class="form-control"
											...
											<option value="12">Tempo (12)</option>
											<option value="18">Mazda (18)</option>
											<option value="24">Mini Bus (24)</option>
											<option value="40">Bus (40)</option>
										</select>
									</div>
									<div class="col-md-2 col-sm-2 col-xs-3 mar-top-15 text-lightgrey ">Travel Time</div>
										<div
										class="col-md-2 col-sm-2 col-xs-3 mar-top-15 text-lightgrey"><input type="text" class="form-control" id="traveltime" name="traveltime"
		...
		<div class="modal fade" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<div class="modal-footer text-center">
						<button type="button" class="btn btn-blue" data-dismiss="modal" onclick="removepoint1();">
							Remove
						</button>
					</div>
				</div>
...
<script>
	...
	function showLandmarks() {
		...
		url = "GetShuttleLandmarks?filter="+filter+"&site="+siteid+"&logtype="+logtype+"&time="+logtime+"&search="+ param1+param2;
	...
	function getEmployee() {
		...
		try {
			...
			xmlhttp.open("POST", "GetEmployeeNearNoodle?site="+siteid+"&filter="+filter+"&logtype="+logtype+"&logtime="+logtime+"&dist=" + compareconst
...
function validate1(){
 ...
 function getTravelTime(startLocation,endLocation){
         ...
         if (status !== google.maps.DistanceMatrixStatus.OK) {
           ...
           for (var i = 0; i < originList.length; i++) {
             ...
             for (var j = 0; j < results.length; j++) {
            	 document.getElementById("traveltime").value=results[j].duration.text;
             }
           } 
         }
       });
