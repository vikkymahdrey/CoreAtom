...
<body>
	...
	//	String manager = request.getParameter("supervisorID1");
		String spoc = request.getParameter("supervisorID1");
		...
		List<EmpSchedule> emplist = reportHelper.getActiveScheduleDetails(
				fromDate, toDate, siteID,  spoc, project,shiftInTime,shiftOutTime,employeeIdParam );
	...
	<div id="body">
		<div class="content">
			<div>
				<form name="form1" action="display_tranadmin_emp_sch_report.jsp"
					...
					<table>
						...
						<tr>
							...
							<td><input type="hidden" name="supervisorID1"
								id="supervisorID1" value="<%=empid%>" /></td>
		...
		<display:table class="alternateColor" name="<%=emplist%>" id="row"
				...
				<display:column property="logoutTime" title="Logout Time"
					sortable="true" headerClass="sortable" />
				<display:column property="projectID" title="Project" sortable="true"
					headerClass="sortable" />
