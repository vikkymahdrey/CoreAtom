...
<%@page import="com.agiledge.atom.reports.EmergencyTransportReportForCD"%>
...
<body>
	...
	String fname3=("EmergencyBookedReport :").concat(new Date().toString()).concat(".xml");
		...
		EmergencyTransportReportForCD reportEmer = new EmergencyTransportReportForCD();
	...
	<div id="body">
		<div class="content">
			<div>
				<form name="form1" action="EmergencyBookingReportForCD.jsp"
