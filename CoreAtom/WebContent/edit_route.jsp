	...
	<div id="body">
		<div class="content">
			<%
				...
				RouteDto routeDto = routeService.getMasterRouteDetails(routeId);
				ArrayList<RouteDto> routTypes = routeService.getRoutetypes();
			%>
					...
					<tbody>
						...
						<tr>
							...
							<td align="left"><select id="routeType" name="routeType">
									<%
										for (RouteDto routeTypedto : routTypes) {
											if (routeDto.getRouteType().equals(routeTypedto.getRouteType())) {
									%>
									<option selected="selected"
										value="<%=routeTypedto.getRouteType()%>"><%=routeTypedto.getRouteTypeDesc()%></option>
									<%
										} else {
									%>
