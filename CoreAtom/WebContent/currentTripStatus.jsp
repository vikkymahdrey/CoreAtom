...
<%@page import="com.agiledge.atom.usermanagement.service.PageService"%>
  ...
  <%
    ...
    ArrayList<LiveTrackingDto> list=new LiveTrackingService().getTripStatus(date,triptime,triplog);
	...
	<div class="content-wrapper mar-top-20">
		<div class="col-sm-12">
			<div class="white-box">
			 ...
			 <h6 align="center" ><img src="images/lv_tack_emp_travel_status.png" />&nbsp;&nbsp;<i>Trip Status</i> </h6>
...
<%
	 ...
	 %> 
	<P align="center"><i> No Trips Running at this time!!!!</i></P>
