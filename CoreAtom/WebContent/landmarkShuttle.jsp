...
<body>
	...
	function showAuditLog(relatedId,moduleName){
		...
		var url="ShowAuditLog.jsp?relatedNodeId="+relatedId+"&moduleName="+moduleName+"&current=LANDMARK";	
	...
	<%
		int placeId = Integer
				.parseInt("" + request.getParameter("placeId"));

		APLService APLServiceObj = new APLService();
		ArrayList<APLDto> APLDtoList = APLServiceObj
				.getShuttleLandmarksByPlaceId(placeId);
		APLDto APLDtoPlace = APLServiceObj.getShuttlePlaceById(placeId);
	%>
			...
			<table>
				<tr>
					...
					<td width="30%"
						...
						<div id="showAddLandmarkDiv" style="padding-top: 3px; position: fixed;" >
						...
						<form name="landmark" action="AddLandmark"
							onsubmit="return validateLandmark();" style="position:fixed; background-color: #ddd; "  >
