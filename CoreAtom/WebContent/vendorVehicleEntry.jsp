...
<body>
	...
	try{
		...
		String vendorCompany = session.getAttribute("vendorCompany")
				.toString();
		System.out.println("vendcom" + vendorCompany);

		ArrayList<TripDetailsDto> tripSheetSaved = new VendorService().getAssignedTrip(vendorCompany, siteId, tripDate, tripTime,tripMode, "assign");

		VendorService vendorService = new VendorService();
		ArrayList<VehicleDto> vehicleDtos = null;
		try {
			vendorService.loadVehiclesVendor(vendorCompany);
		} catch (Exception e) {
		...
		<div class="content">
			...
			<table border="1" style=" width:85%; ">
						...
						<div>
							<table>
								...
								<tr>
									...
									<td><button id="enableEscort" onclick="escortEnabled()">Enabled Escort</button></td>
									
								</tr>
								<tr>
									<td>Travel Time</td>
									<td><input type="text" name="traveltime<%=tripDetailsDtoObj.getId()%>"  value="<%=tripDetailsDtoObj.getTravelTime()%>"></td>
								</tr>
								<tr>
									<td>TotalDistance</td>
				...
				<tr>
					...
					<td><input type="text" name="travellingtime<%=tripDetailsDtoObj.getTravelTime()%>" value="<%=tripDetailsDtoObj.getTravelTime()%>" ></td>
				</tr>
				<%
					i++;
							}
