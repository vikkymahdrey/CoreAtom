...
function displayExistingLandmarks()
{
		if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
			...
			var latlng = new google.maps.LatLng(ltln[4],ltln[5]);
						placeMarker(latlng);
						codeAddress(ltln[3]+","+ltln[1]+","+ltln[0])
...
function displayWindowForSetAPL(marker,event) {
	...
	latlng=latlng[0]+"$"+latlng[1];	
	  ...
	  message=message+'<tr><td>Place</td><td id="place"><Select name="place"><option value="">Select</option></select></td></tr><tr><td>Land Mark</td><td id="landmark"><select name="landmarkId" ></select></td></tr><tr><td><input type="hidden" value=';
