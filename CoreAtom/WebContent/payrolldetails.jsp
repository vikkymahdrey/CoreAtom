...
<script type="text/javascript">
            ...
            function getPayrollDetails()
            {
                ...
                var url1="GetPayrollDetails?month=" + $("select[name=month]").val() + "&year=" + $("select[name=year]").val();
                $("#loadImageOfSupervisor2").html("<img   id=\"loadingImage\" src=\"images/ajax-loader.gif\"/>");
                $.ajax({
	...
	<div id="body">
		<div class="content">
			...
			<form id="frmGetPayrollDetails" name="frmGetPayrollDetails"
				method="post" action="payrolldetails.jsp">
				<table width="529">
					<tr>
