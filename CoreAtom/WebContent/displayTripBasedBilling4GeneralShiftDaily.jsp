...
<title>TRIP Based Classic Billing Report - General Shift</title>
...
function getSummaryReport(siteId,date,option, vendor)
{
	...
	var url="displayTripBasedBilling4GeneralShiftDaily.jsp?siteId=" + siteId+"&fromDate="+date+"&toDate="+date+"&vendor="+vendor;
        			...
        			try {
        				...
        				xmlhttp.onreadystatechange = function() {
        					...
        					//	alert(fullvehicle);
        						...
        						document.getElementById("vehicleTypeAdded").innerHTML = "<select name='chosenVehicleType' id='chosenVehicleType'  ><option value='all'>All</option>"+fullvehicle[1]+"</select>";
...
<body>
	...
	%>
			...
			<div>
				<form name="form1" action="displayTripBasedBilling4GeneralShiftDaily.jsp"
			...
			<hr />
			<br />
			<h2 align="center">Trip Based Daily Billing Report - General Shift</h2>
			<hr />
			<%
