...
<title>Trip Billing Report - General Shift</title>
...
{ 
	 alert('go');
	var urlP=url + "&month=" + month + "&year=" + year;
...
function getSummaryReport(siteId,date,option, vendor)
{
	...
	var url="displayKmBasedTemplateBilling4GeneralShiftDaily.jsp?siteId=" + siteId+"&fromDate="+date+"&toDate="+date+"&vendor="+vendor;
...
<body>
	...
	<div id="body">
		...
		String  url="displayKmBasedTemplateBilling4GeneralShiftDaily.jsp?siteId=" + siteID+"&fromDate="+fromDate+"&toDate="+toDate+"&vendor="+vendor;
		//vendor="1";
	...
	%>
			...
			<div>
				<form name="form1" action="displaySlabBasedBilling4GeneralShiftDaily.jsp"
			...
			<hr />
			<br />
			<h2 align="center">Trip Billing Report - General Shift</h2>
			<hr />
			<%
			ArrayList<TripBasedBillingReportHelperDto> dtoList =null;
			try{
				dtoList = new SlabBasedBillingReportHelperDao().getSlabBasedBillingTripCostReport_daily(siteID, vendor, vehicleType, fromDate, toDate,month,year, escort);
		...
		%>
				 ...
				 <disp:dipxColumn group="1" style="text-align:center;" format="{0,date,dd/MM/yyy}" property="date" title="Date"/>
				 ...
				 <disp:dipxColumn style="text-align:center;" sortable="true" property="escortRate"  format="{0,number,0.00}"  title="Escort Cost"  />
