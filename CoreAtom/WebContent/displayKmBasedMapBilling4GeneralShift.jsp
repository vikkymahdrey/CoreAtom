 ...
 <%@page import="com.agiledge.atom.billingprocess.report.dao.KmBasedMapBillingReportHelperDao"%>
...
<title>Km Based Map Billing Report - General Shift</title>
...
function getSummaryReport(siteId,date,option, vendor)
{
	...
	var url="displayKmBasedMapBilling4GeneralShift.jsp?siteId=" + siteId+"&fromDate="+date+"&toDate="+date+"&vendor="+vendor;
...
<body>
	...
	<div id="body">
		...
		String  url="displayKmBasedMapBilling4GeneralShift.jsp?siteId=" + siteID+"&fromDate="+fromDate+"&toDate="+toDate+"&vendor="+vendor;
		//vendor="1";
	...
	%>
	 ...
	 <hr/>
			<div>
				<form name="form1" action="displayKmBasedMapBilling4GeneralShift.jsp"
			...
			try{
				dtoList = new KmBasedMapBillingReportHelperDao().getKmBasedMapBillingTripCostReport_monthly(siteID, vendor, vehicleType, fromDate, toDate,month,year,escort," " );
