...
<script type="text/javascript">
	...
	function confirmValidate() {
		...
		var fromdatedata = $("input[name=fromdatedata]").val();
		if(fromdatedata=="")
		{
		flag=false;
...
<%@include file="Header.jsp"%>
	...
	%>
			...
			<form action="UpdateSubscriptionWithFromdate" name="subscriptionForm">
				...
				<%
					boolean aplChangePrivilege = true;
						                        boolean editPrivilage=true;
...
System.out.println("Edit Previlage"+editPrivilage+"   apl change previlage"+aplChangePrivilege);
 ...
 %></td>
					...
					<td><input type="Text" name = "fromdatedata"
							id="fromdatedata"  class="required"
							class="{showOtherMonths: true, firstDay: 1, dateFormat: 'MM-DD-YYY', minDate: new Date(2012,  1, 25)}" /><label
							for="fromDate" class="requiredLabel">*</label></td>
					</tr>
