								...
								.click(
										function() {
											if ($(this).is(":checked")) {
												...
												$("select[name='logoutTime"+ $(this).val()+ "']").val($("input[name='oldlogoutime"+ $(this).val()+ "']").val());
			...
			<div>
				<%
					try {
						...
						LogTimeService logTimeservice=new LogTimeService();
						ArrayList<LogTimeDto> loginTimes=logTimeservice.getAllTimeWithProjectSpecificForEmployee(employeeId, "IN");
						ArrayList<LogTimeDto> logoutTimes=logTimeservice.getAllTimeWithProjectSpecificForEmployee(employeeId, "OUT");
						...
						<tbody>
							...
							<tr>
								...
								+ scheduleAlterDto.getDate()%>">
										...
										<%
										for(LogTimeDto logTimeDto:loginTimes)
										{
										...
										for(LogTimeDto logTimeDto:loginTimes)
										{
											if(logTimeDto.getLogTime().equals(scheduleAlterDto.getLoginTime())){
										%>
										<option selected="selected" value="<%=logTimeDto.getLogTime()%>"><%=logTimeDto.getLogTime()%></option>
										<%
										}
											else {
										%>
								...
								+ scheduleAlterDto.getDate()%>">
										...
										<option value="weekly off">Weekly OFF</option>
										<%
										for(LogTimeDto logTimeDto:logoutTimes)
										{
										...
										for(LogTimeDto logTimeDto:logoutTimes)
										{
											if(logTimeDto.getLogTime().equals(scheduleAlterDto.getLogoutTime()))
											{
										%>
										<option selected="selected"value="<%=scheduleAlterDto.getLogoutTime()%>"><%=scheduleAlterDto.getLogoutTime()%></option>
										<%}
											else
											{%>
										<option value="<%=logTimeDto.getLogTime()%>"><%=logTimeDto.getLogTime()%></option>
