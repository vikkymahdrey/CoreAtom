						...
						<div class="col-sm-12">
							...
							<div class="content-wrap">
								...
								<div class="profile-google-map mar-top-30">
									<div class="row">
										<div class="col-sm-12">
										<input type="button" id="removepoint" name="removepoint" value="Remove Points" class="btn btn-blue save-btn" onclick="removepoints();">
...
<script>
	...
	function getEmployee() {
		...
		try {
			...
			xmlhttp.open("POST", "GetEmployeeNearNoodle?dist=" + compareconst
