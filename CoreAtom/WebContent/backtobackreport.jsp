...
<body  >
	...
	%>
	<div>
	<form name="form" id="form" action="display_tripreport.jsp"
			...
			try{
				dtoList = new TripBasedBillingReportHelperDao ().getTripsMonthly(site, fromDate, toDate);	 
		...
		%>
				    ...
				    <display:column property="trip_date" sortable="true" title="Date"  href="display_tripreportDaily.jsp?siteId=${siteID}"  paramId="Date" />
				 	<display:column property="totalcount" sortable="true" title="Total Trips" total="true" format="{0,number,0}"  />
				 	<display:column property="incount"  sortable="true" title="In Trips" total="true" format="{0,number,0}" />
				 	<display:column property="outcount" sortable="true" title="Out Trips" total="true" format="{0,number,0}"/>
				 	<<display:column property="normalcount" sortable="true" title=NormalTrips" total="true" format="{0,number,0}"/>
				 	<display:column property="backcount" sortable="true" title="Back 2 Back Trips" total="true" format="{0,number,0}"/>
				 	<display:column property="escortcount"  sortable="true" title="Escort Trips" total="true" format="{0,number,0}" />
				 	<display:column property="nonescortcount"  sortable="true" title="Non Escort Trips"  total="true" format="{0,number,0}" />
