...
<body onload="loadScript();">
	<%
		...
		ArrayList<RouteDto> list1 =new RouteService().getAutogeneratedRoutelistWithLog();
	%>
	...
	<div class="wrapper">
		...
		<div class="main-page-container">
			<div class="container">
				<form action="compareAutoGeneratedRoute1.jsp" method="post"
					onsubmit="return validate();">
					<div class="row">
						<div class="col-sm-12">
							<div class="breadcrumb-wrap">
								<a href="employee_home.jsp"><img src="images/home.png" /></a> <a
									href="employee_home.jsp">My Information </a> <a
									href="createRouteUsingEmployeePoints1.jsp">Create Route </a> <a
									href="#" class="current">Compare Route </a>
...
showroutename();
	...
	function showroutename(){
		...
		%>
		msgtable+="<tr><td>"+cnt+"</td><td><%=dto.getRouteName()%></td><td><%=dto.getInOut()%></td><td><%=dto.getVehicleType()%></td><td><%=cap%></td><td><%=dto.getVehicleCount()%></td><td><%=dto.getInOut()%></td><td><%=dto.getTime()%></td><td><a href='updateAutoGeneratedRouteWithLog.jsp?routeid=<%=dto.getRouteId()%>'>Edit</a></td></tr>";
		cnt++;
	<%}%>
		msgtable+="</table>";
