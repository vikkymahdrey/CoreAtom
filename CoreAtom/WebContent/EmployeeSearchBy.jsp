...
<script type="text/javascript">
	...
	{		
		if (confirm()) {
			...
			try {
				...
				xmlhttp.open("POST", "GetEmployeeByData?empID="
						+ document.SearchForm.empID.value + "&firstName="
	...
	function selectRow(id) {
		...
		opener.document.getElementById("empID").value = id;
		opener.document.getElementById("empName").value = name;
	...
	function setEmployeeDetails(id)
	{
		try {
			...
			var url="GetEmployeeByDetails?empID="+id+"&isSub=true";
