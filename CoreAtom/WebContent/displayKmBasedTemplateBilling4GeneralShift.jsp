...
function getSummaryReport(siteId,date,option, vendor)
{
	...
	var url="displayKmBasedTemplateBilling4GeneralShift.jsp?siteId=" + siteId+"&fromDate="+date+"&toDate="+date+"&vendor="+vendor;
...
<body>
	...
	<div id="body">
		...
		String  url="displayKmBasedTemplateBilling4GeneralShift.jsp?siteId=" + siteID+"&fromDate="+fromDate+"&toDate="+toDate+"&vendor="+vendor;
		//vendor="1";
	...
	%>
	 ...
	 <hr/>
			<div>
				<form name="form1" action="displayKmBasedTemplateBilling4GeneralShift.jsp"
			...
			try{
				dtoList = new KmBasedTemplateBillingReportHelperDao().getKmBasedTemplateBillingTripCostReport_monthly(siteID, vendor, vehicleType, fromDate, toDate,month,year,escort," " );
