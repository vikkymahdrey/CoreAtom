...
/**
 * Servlet implementation class AddSlabBasedBillingCofig
 */
 
public class AddSlabBasedBillingConfig extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSlabBasedBillingConfig() {
        super();
	...
	private void processRequest(HttpServletRequest request,
		...
		try{
			...
			{
			int val=service.addSlabBasedBillingConfig(dto); 
			if(val>0)
			{
				request.getSession().setAttribute("status",
						"<div class=\"success\" width=\"100%\" > New Slab Rate Set Up Successfully</div>");
