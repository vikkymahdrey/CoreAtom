...
public class AddKmBasedTemplateBillingConfig extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddKmBasedTemplateBillingConfig() {
        super();
	...
	private void processRequest(HttpServletRequest request,
		...
		String swingRate =  request.getParameter("swingRate")==null ?"": request.getParameter("swingRate"); 
		String swingRateType = request.getParameter("swingRateType")==null ?"": request.getParameter("swingRateType");
		...
		try{
			...
			KmBasedTemplateTripBillingConfigDto dto = new KmBasedTemplateTripBillingConfigDto();
			 ...
			 dto.setSwingRateType(swingRateType);
			...
			if(service.validateKmBasedTemplateBilling(dto) ==false)
			{
			...
			{
			int val=service.addKmBasedTemplateConfig(dto);
			if(val>0)
			{
				request.getSession().setAttribute("status",
