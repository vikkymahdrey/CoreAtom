...
public class SendMailCrossDomain implements Runnable, SendMail {
	public static String sourceMail = "transport@cross-domain.com";
	public static String password = "Cross!23";

	private String protocol = "smtp";
	private String host = "smtp.rediffmailpro.com";
