...
public class SendMailLogica implements Runnable, SendMail {
	public static String sourceMail = "INTransport@CGI.com";
	public static String password = "agileagile";

	private String protocol = "smtp";
	private String host = "smtp.se.logica.com";
	...
	public void send(String destadd, String sub, String dat) {
	  // 	printMail(destadd, sub, dat);
		...
		// this.destadds = new String[] { "stanly.joshua@logica.com",
		// "raman.kutty@logica.com"};

		// this.destadds = new String[] { "noufalrandathani@yahoo.com",
		// "raman.kutty@logica.com"};
		// this.destadd="raman.kutty@logica.com";
	...
	public void send_invokedByRun(String destadd, String sub, String dat)
		...
		// System.out.println(protocol + host + auth + smtpPort);
		...
		// message.setSender(new InternetAddress(sourceMail));
	...
	private void printMailForMultiple(String[] destadd, String sub, String dat) {

		System.out.println("addresses : ");
		for (String dest : destadd) {
