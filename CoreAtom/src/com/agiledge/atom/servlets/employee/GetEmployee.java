...
public class GetEmployee extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			 ...
			 * out.println("<h1>Servlet GetEmployee at " +
			...
			String employeeName = request.getParameter("supervisor1Text");
			// System.out.println(" Text " + employeeName);
			// System.out.println(" Attr " +
			// request.getAttribute("supervisor1Text").toString());
			List<EmployeeDto> empList = dao.getEmployee(request
					.getParameter("supervisor1Text"));
			String employeePipe = "";
			for (EmployeeDto emp : empList) {
				employeePipe += emp.getEmployeeID() + ":"
