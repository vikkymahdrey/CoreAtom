...
/**
 * Servlet implementation class AddVendorMaster
 */
 
public class AddVendorMaster extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddVendorMaster() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			int value=0;
			value= new VendorService().addVendorMaster(dto);
			...
			{
				request.getSession().setAttribute("status",
						"<div class=\"failure\" width=\"100%\" > Subscription addition failure</div>");
