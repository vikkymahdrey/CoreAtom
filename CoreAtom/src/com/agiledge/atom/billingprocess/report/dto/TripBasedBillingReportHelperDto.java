...
public class TripBasedBillingReportHelperDto {
	...
	public String toString() {
		return "TripBasedBillingReportHelperDto [monthName=" + monthName
				+ ", fromDate=" + fromDate + ", toDate=" + toDate + ", date="
				+ date + ", vehicleType=" + vehicleType + ", totalTrips="
				+ totalTrips + ", rate=" + rate + ", fromKm=" + fromKm
				+ ", toKm=" + toKm + ", distanceRange=" + distanceRange
