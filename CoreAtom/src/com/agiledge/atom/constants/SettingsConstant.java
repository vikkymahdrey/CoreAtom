...
public class SettingsConstant
{
    ...
    public static String andrioidTripDetailsCount = "10";
    public static Map deviceMap = new HashMap();
    public static Map tripMap = new HashMap();
    public static ArrayList inpicLogs = new ArrayList();
    public static ArrayList outLogs = new ArrayList();
    public static String scheduleSingleDayCutOff="";
    ...
    public static void setCompany()
    {
        ...
        if(comp.equalsIgnoreCase("gss"))
        {
            ...
            url = "jdbc:mysql://10.20.14.5:3306/atomcoredemo";
            ...
            scheduleCutOffDuration = "56:00";
            showDesigOrRole = "role";
            shiftExtensionWithoutSchedule = "no";
            driverPassword = "mobileno";
            vehicleAssignCutOff = "true";
            vehicleAssignCutOffDuration = "01:30";
        } else
        if(comp.equalsIgnoreCase("tyko"))
        {
            transportTeamNumber = "";
            transportTeamEmail = "vikky@agiledgesolutions.com";
            emailFlag = "";
            smsFlag = "";
            validationFlag = "";
            utiltiyRun = "no";
            ...
            getEmpSource = "uat";
            emailForScheduleEmployee = "no";
            url = "jdbc:mysql://180.179.227.102:3306/atomcoredemo1";
            propertyFile = "gssdb.property";
            hibernateFile = "hibernate.cfg.gss.xml";
            empAuthinticationForComet = "loginid";
            dayreportBean = "DayreportBeangss";
        	...
        	if(comp.equalsIgnoreCase("tyko"))
            {
                ...
                getEmpSource = "uat";
                emailForScheduleEmployee = "no";
                url = "jdbc:mysql://10.20.14.5:3306/atomtyko";
                propertyFile = "gssdb.property";
                hibernateFile = "hibernate.cfg.gss.xml";
                empAuthinticationForComet = "loginid";
                dayreportBean = "DayreportBeangss";
        ...
        if(comp.equalsIgnoreCase("cdtemp1"))
        {
        	...
        	if(comp.equalsIgnoreCase("keo"))
            {
                ...
                showDesigOrRole = "";
            	 ...
            	 if(comp.equalsIgnoreCase("visa"))
                 {
                     transportTeamNumber = "9620300915";
                     transportTeamEmail = "vikky@agiledgesolutions.com";
                     emailFlag = "uat";
                     smsFlag = "uat";
                     validationFlag = "api";
                     ...
                     getEmpSource = "uat";
                     emailForScheduleEmployee = "no";
                     url = "jdbc:mysql://10.20.14.4:3306/atomcoredemovisa1";
                     propertyFile = "gssdb.property";
                     hibernateFile = "hibernate.cfg.gss.xml";
                     empAuthinticationForComet = "loginid";
                     APPROVAL_TYPE = "Approved by Transport Manager";
    ...
    public static String getCurdate()
    {
        ...
        String returnDate = (new StringBuilder()).append(curCal.get(5) <= 9 ? ((Object) ((new StringBuilder("0")).append(curCal.get(5)).toString())) : ((Object) (Integer.valueOf(curCal.get(5))))).append("/").append(curCal.get(2) + 1 <= 9 ? ((Object) ((new StringBuilder("0")).append(curCal.get(2) + 1).toString())) : ((Object) (Integer.valueOf(curCal.get(2) + 1)))).append("/").append(curCal.get(1)).toString();
        try
        {
            if(scheduleCutOff.equalsIgnoreCase("true"))
            {
                ...
                {
                    returnDate = (new StringBuilder()).append(toTime.get(5) <= 9 ? ((Object) ((new StringBuilder("0")).append(toTime.get(5)).toString())) : ((Object) (Integer.valueOf(toTime.get(5))))).append("/").append(toTime.get(2) + 1 <= 9 ? ((Object) ((new StringBuilder("0")).append(toTime.get(2) + 1).toString())) : ((Object) (Integer.valueOf(toTime.get(2) + 1)))).append("/").append(toTime.get(1)).toString();
                }
            }
        }
        catch(Exception e)
